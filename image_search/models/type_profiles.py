...
TYPE_PROFILES: dict[str, ItemTypeProfile] = {
    ...
    "backpieces": ItemTypeProfile(
        keywords=("back", "backpack", "pack", "wing", "wings", "tail", "cape", "bow", "ribbon", "horn", "antler"),
        style_patterns=DECOR_STYLE_PATTERNS[:3],
        prefer_icon=True,
        blocked_patterns_icon=TOP_GARMENT_PATTERNS + BOTTOM_GARMENT_PATTERNS,
    ),
    ...
    "abilityHandhelds": ItemTypeProfile(
        keywords=("staff", "wand", "scepter", "lantern", "umbrella", "parasol", "fan", "sword", "blade", "instrument", "violin", "guitar", "flute", "harp", "mirror", "bag", "handheld"),
        style_patterns=DECOR_STYLE_PATTERNS[:3],
        prefer_icon=True,
        blocked_patterns_icon=TOP_GARMENT_PATTERNS + BOTTOM_GARMENT_PATTERNS,
    ),
